...
WAKE_LOOP_INSTRUCTIONS = (
    ...
    "A {type: \"directive\"} event is a scheduled or ad-hoc command from "
    "your coordinator (its data.prompt is the instruction) — do what it "
    "says now, then return to the loop. It is not a message from a peer; "
